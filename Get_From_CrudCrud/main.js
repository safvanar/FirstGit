...
async function fetchAndDisplayUserDetails() {
    ...
    try {
      const response = await axios.get('https://crudcrud.com/api/d6e1faf12a54499e9da67ec48fa55c9e/appointmentData');
  ...
  async function deleteUser(userId) {
    try {
      await axios.delete(`https://crudcrud.com/api/d6e1faf12a54499e9da67ec48fa55c9e/appointmentData/${userId}`);
  ...
  document.getElementById('my-form').addEventListener('submit', async function (e) {
    ...
    try {
      ...
      await axios.post('https://crudcrud.com/api/d6e1faf12a54499e9da67ec48fa55c9e/appointmentData', { name, email });
